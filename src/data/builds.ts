...
export const builds: Build[] = [
  // STARTER BUILDS
  {
    ...
    description: "Best bang for buck at around $700. Handles 1080p gaming at high settings.",
    totalPrice: 700,
    tier: "budget",
    variant: "microcenter",
  ...
  },
  {
    ...
    description: "Worse value than Intel, but worth it if you need CUDA, DLSS, or a specific use case",
    totalPrice: 800,
    tier: "budget",
    variant: "nvidia",
  ...
  },
  {
    ...
    description: "Worse value than AMD, but worth it if you need CUDA, DLSS, or a specific use case.",
    totalPrice: 1430,
    variant: "nvidia",
    tier: "mid",
